...
const Footer = () => {
  return (
    <div className="bg-primary   ">
      <div className="relative h-[500px] lg:h-80"> {/* Reduced height */}
        ...
        <div className="absolute inset-0 flex items-start justify-center text-white text-xs lg:text-sm pt-10 lg:pt-16">
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 px-4">
            {/* first col */}
            <div className="flex flex-col items-center md:items-start mb-6 pt-16 lg:pt-0 md:mb-0"> {/* Added margin-bottom for spacing */}
      ...
      {/* copyright */}
      <div className="flex flex-col lg:flex-row lg:px-16 items-center justify-center lg:text-xs text-xs lg:py-1 py-1 lg:gap-16 text-white "> {/* Adjusted for small screens */}
