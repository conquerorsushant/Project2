...
import img4 from "../../assets/images/Asset32.png";
import img5 from "../../assets/images/Asset24.png";
...
import img10 from "../../assets/images/Asset22.png";
import img11 from "../../assets/images/Asset27.png";
  ...
  return (
    <div className="bg-primary relative text-white">
      ...
      <div className="relative">
        {/* Left Image */}
        <div className="absolute left-0 top-0 w-1/4 h-full  items-center justify-center hidden lg:block">
        ...
        <div className="flex flex-col items-center justify-center pt-8 px-4 sm:px-8 lg:px-12 relative">
          ...
          <div className="flex flex-col lg:flex-row items-start px-2 lg:px-44">
            <div className="text-lg mt-4 max-w-full lg:max-w-2xl text-start px-4 lg:px-24">
              <h3 className="text-sm lg:text-2xl font-semibold">Discovery Workshop:</h3>
            ...
            <div className="text-lg mt-4 max-w-full lg:max-w-2xl text-start px-4 lg:px-24">
              <h3 className="text-sm  lg:text-2xl font-semibold">Solution Design:</h3>
        ...
        {/* Right Image */}
        <div className="absolute right-0 top-0 w-1/4 h-full  items-center justify-center hidden lg:block">
        ...
        <div className="flex flex-col  items-center justify-center pt-8 px-4 sm:px-8">
          ...
          <div className="flex flex-col lg:flex-row items-start px-4 lg:px-44">
            <div className="text-lg mt-4 max-w-full lg:max-w-2xl text-start px-4 lg:px-16 lg:ml-20">
              <h3 className="text-sm lg:text-2xl font-semibold">Implementation & Deployment:</h3>
              <p className="pt-4 lg:pt-6 text-xs lg:text-base">
            ...
            <div className="text-lg mt-4 max-w-full lg:max-w-2xl text-start px-4 lg:px-16 lg:ml-40">
              <h3 className="text-sm lg:text-2xl font-semibold">Proof of Concept (POC):</h3>
              <p className="pt-4 lg:pt-6 text-xs lg:text-base ">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center pt-8 px-4 sm:px-8">
          ...
          <div className="text-lg mt-4 max-w-full lg:max-w-2xl text-start p-4">
            <h3 className="text-sm lg:text-2xl font-semibold">Ongoing Support</h3>
            <p className="pt-4 lg:pt-6 text-xs lg:text-base">
      ...
      <div className="relative mt-12 sm:mt-24 lg:mt-28">
        ...
        {/* Overlay Image */}
        <img src={img5} alt="Overlay" className="absolute top-0 left-0 w-full h-[310px] object-cover opacity-70 z-20" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-30 text-center px-4 sm:px-8">
          <h2 className="text-xl sm:text-3xl lg:text-3xl font-bold p-2 sm:p-4 rounded-lg shadow-lg">
          How We Can Help You: Solutions for
          Every Business Size
          </h2>
          <p className="text-base sm:text-xl lg:text-xl font-semibold mt-2 sm:mt-4 max-w-full sm:max-w-2xl mx-auto rounded-lg shadow-lg">
      ...
      <div className="flex flex-col lg:flex-row px-2 sm:px-8 lg:px-12 pt-8 sm:pt-12">
        <div className="flex-1 px-4">
          <div className="flex items-start justify-center gap-2 lg:gap-4 lg:p-4  lg:mx-8">
            <img src={img6} alt="In-House Training Icon" className="w-8 h-8 sm:w-16 sm:h-16" />
            <div className="text-lg">
              <h2 className="text-sm lg:text-2xl font-semibold">MSMEs:</h2>
          ...
          <div className="flex items-start justify-center gap-2 lg:gap-4 lg:p-4  lg:mx-8 mt-4">
            <img src={img7} alt="In-House Training Icon" className="w-8 h-8 sm:w-16 sm:h-16" />
            <div className="text-lg">
              <h2 className="text-sm lg:text-2xl font-semibold">Enterprises:</h2>
              <p className="mt-2 text-xs lg:text-base">
                Our team continuously undergoes rigorous training to stay at
                the forefront of the ever-evolving data engineering landscape.
                This ensures we leverage the latest advancements and best
        ...
        <div className="flex-1 px-4">
          <div className="flex items-start justify-center gap-2 lg:gap-4 lg:p-4  lg:mx-8 mt-4">
            <img src={img8} alt="In-House Training Icon" className="w-8 h-8 sm:w-16 sm:h-16" />
            <div className="text-lg">
              <h2 className="text-sm lg:text-2xl font-semibold">Startups:</h2>
              <p className="mt-2 text-xs lg:text-base">
                Our team continuously undergoes rigorous training to stay at
                the forefront of the ever-evolving data engineering landscape.
                This ensures we leverage the latest advancements and best
          ...
          <div className="flex items-center justify-start pt-6 lg:pl-12 lg:pt-9 gap-4">
            <img src={img9} alt="In-House Training Icon" className="" />
          </div>
        </div>
      </div>
