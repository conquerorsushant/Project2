    ...
    s55: (
      <div>
        <p>
          ...
          their digital goals. Few success stories include:
        </p>
        <ul class="list-disc text-white">
          <li>
            Increased online leads by 67% for a leading e-commerce platform in
            the fashion industry through strategic website redesign and SEO
            optimization.
          </li>
          <li>
            Developed a custom content management system (CMS) for a healthcare
            organization, streamlining content creation and management,
            resulting in a 42% reduction in content update turnaround time.
          </li>
          <li>
            Built a high-performance e-commerce website for a sporting goods
            retailer, enabling a 25% increase in online sales within the first
            year of launch.
          </li>
          <li>
            Designed and implemented a user-friendly website for a non-profit
            organization, leading to a 38% growth in volunteer signups and
            donations.
          </li>
          <li>
            Created a data-driven website for a real estate agency, improving
            property search functionality and user engagement, resulting in a
