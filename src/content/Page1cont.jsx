...
const page1Content = {
  sec1: {
    ...
    t5: (
      <p>
        ...
        experiences, and drive loyalty. We leverage cutting-edge CRM
        technologies and proven methodologies to design, develop, and implement
        customized CRM solutions that enhance your ability to connect with
        customers, manage interactions effectively, and ultimately, achieve your
        business goals.
      </p>
    ),
    t6: (
      <h3 className="text-xl lg:text-3xl font-bold mb-4 text-center">
        Building Powerful CRM Solutions:
      </h3>
    ),
    t7: (
    ...
    t8: (
      <p className="text-lg lg:text-xl lg:text-center text-center">
        We are proficient in a comprehensive suite of CRM technologies and
        frameworks to craft the perfect solution for your needs:
      </p>
    ),
  },
  sec2: {
    ...
    p1: <p>Leading CRM Platforms:</p>,
    a1: <img src={imga1} alt="Leading CRM Platforms" />,
    p2: <p>Custom CRM Development:</p>,
    p3: <p>API Integrations:</p>,
    p4: <p>Data Management &amp; Analytics:</p>,
    ...
    smoothp: (
      <p>
        ...
        positive experience throughout your CRM development journey with
  ...
  sec3: {
    ...
    d11: <p>We begin with an in-depth workshop to understand your
    business goals, customer touchpoints, and pain points related to customer relationship
    management.</p>,
    d2: <p>CRM Platform Selection or Customization Planning:</p>,
    d22: <p>We help you select the most suitable
    CRM platform based on your needs, or if required, plan the development roadmap for a custom
    CRM solution.</p>,
    d3: <p>Data Migration &amp; System Integration:</p>,
    d33: <p>Our team can assist with data migration from existing
    systems and integrate your CRM with other relevant applications to ensure a unified data
    landscape.</p>,
    d4: <p>CRM Configuration &amp; Customization:</p>,
    d44: <p>We configure the chosen CRM platform or develop your
custom solution based on the agreed-upon functionalities and workflows.</p>,
    d5: <p>User Training &amp; Ongoing Support:</p>,
    d55: <p>We provide comprehensive user training to ensure your
    team can leverage the CRM effectively. We also offer ongoing support to address any issues and
    provide guidance as your needs evolve.</p>,
