  ...
  sec2: {
    ...
    s66: (
      <p style={{ textAlign: "justify" }}>
        ...
        for a leading fashion retailer, resulting in a 35% increase in online
        sales within the first year. ○ Built a custom e-commerce solution for a
        sporting goods manufacturer, streamlining their product catalog
        management and increasing online order processing efficiency by 20%. ○
        Developed a feature-rich marketplace platform for a health and wellness
        industry client, facilitating a 2x growth in their participating vendors
