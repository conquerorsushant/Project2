...
const page8Content = {
  sec1: {
    ...
    t5: (
      <p>
        ...
        Our team of data scientists, machine learning engineers, and strategists
        works collaboratively with you to understand your unique business
        challenges and translate them into intelligent solutions that drive
        real-world results.
      </p>
    ),
    t6: (
    ...
    t8: (
      <p className="text-lg lg:text-xl lg:text-center text-center">
        ...
        deliver cutting-edge AI/ML models tailored to your specific needs:
      </p>
    ),
  },
  sec2: {
    ...
    p22: (
      <p>
        ...
        optimally prepared for model training.
      </p>
    ),
    p33: (
      <p>
        ...
        to optimize model performance and accuracy.
      </p>
    ),
    p44: (
      <p>
        ...
        infrastructure or cloud platform for real-world application.
      </p>
    ),
    p55: (
      <p>
    ...
    smooth: (
      <p>A Smooth Onboarding Experience: Your AI/ML Journey Starts Here</p>
    ),
    smoothp: (
      <p>
        We prioritize a clear and efficient onboarding process to ensure a
        positive experience throughout your AI/ML model development journey:
      </p>
    ),
  },
  sec3: {
    ...
    d11: (
      <p>
        ...
        business goals, challenges, and available data.
      </p>
    ),
    d2: <p>Data Analysis &amp; Feature Engineering:</p>,
    d22: (
      <p>
        Our data scientists analyze your data to identify patterns, trends, and
    ...
    d44: (
      <p>
        ...
        techniques like hyperparameter tuning to achieve optimal accuracy.
      </p>
    ),
    d5: <p>Deployment &amp; Integration:</p>,
    d55: (
      <p>
        We deploy the trained model into your desired environment and integrate
    ...
    d66: (
      <p>
        ...
        continues to perform effectively as your data evolves over time.
      </p>
    ),

    e1: <p>How We Can Help You: AI/ML Solutions for Every Business Size</p>,
    e11: (
      <p>
        Our AI/ML development expertise caters to the specific needs of
    ...
    f55: (
      <p>
        ...
        automating document processing, streamlining customer service
  ...
  faq: {
    ...
    ans1: (
      <p>
        ...
        <span style={{ fontWeight: "lighter", opacity: "0.7" }}>
          {" "}
          Free up your human workforce to focus on higher-level activities.
        </span>
        <br />
        <b>Gaining deeper customer insights:</b>
        <br />
        <span style={{ fontWeight: "lighter", opacity: "0.7" }}>
          {" "}
          Uncover hidden patterns and trends in your data to better understand
          your customers and personalize their experiences.
        </span>
        <br />
        <b>Improving operational efficiency:</b>
        <br />
        <span style={{ fontWeight: "lighter", opacity: "0.7" }}>
          {" "}
          Optimize your processes and workflows for increased productivity and
          cost savings.
        </span>
        <br />
        <b>Developing innovative products and services:</b>
        <br />
        <span style={{ fontWeight: "lighter", opacity: "0.7" }}>
          {" "}
          Leverage AI/ML to create cutting-edge solutions that differentiate you
    ...
    ans2: (
      <p>
        The amount of data required for effective AI/ML model development can
        vary depending on the complexity of the problem you&#39;re trying to
        solve. However, with advanced techniques like transfer learning, we can
        often leverage pre-trained models and adapt them to your specific needs
        even with relatively smaller datasets.
      </p>
    ),
    que3: <p>How much does AI/ML model development cost?</p>,
    ans3: (
      <p>
        The cost of AI/ML development can vary depending on the complexity of
        the project, the amount of data involved, and the desired level of
        customization. During the discovery phase, we provide a transparent cost
    ...
    ans4: (
      <p>
        The development timeline can vary depending on the project&#39;s
        complexity and data availability. Our agile approach allows for
        flexibility and iterative development, ensuring the model meets your
    ...
    ans5: (
      <p>
        Explainable AI (XAI) is a set of techniques that helps us understand how
        an AI model arrives at its decisions. This transparency is crucial for
        building trust in AI systems and ensuring they align with your business
    ...
    ready1: (
      <p>
        ...
        businesses to harness the transformative power of AI/ML. Contact us
