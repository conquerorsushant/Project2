    ...
    <div className="">
      <div className="banner relative">
        <div className="banner__content container">
          <div class="col-md-8 ">
            <h1 class="banner__content-title ml-[4.9rem] pt-[4.8rem] front-heading max-w-[80%]">
            ...
            <div className="col-md-6 ">
              <div className="black-bg-text ">
                <p className="text-left brain-text p-3 ">
                  BrainsTerra Intelligence enables technical and non-technical
                  CEOs/Founders to start, and excel in their businesses by
                  helping them in building their high-quality engineering teams,
                  and developing technology products for them. Companies can
                  outsource all IT and tech development work from us until they
                  have their own tech teams.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-md-6">
              <div className="top-style">
                ...
                <p className="font-weight-bold left-bold px-8">
                  Whether it is the starting or expansion of your business, we
          ...
          <div className="col-md-6">
            ...
            <div className="black-bg-text">
              <p className="text-left  black-text p-3">
                ...
                practices, data science modeling, deep learning, computer
                vision, natural language processing, AI-powered software
                building, and traditional yet modern SaaS-based software
                development.
              </p>
            </div>
